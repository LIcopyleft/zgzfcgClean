...
package com.spring.springbootdemo.es;
...
import com.spring.springbootdemo.utils.DBHelper;
...
public class BulkProcessDemo_1 {

    private static final Logger logger = LogManager.getLogger(BulkProcessDemo_1.class);

    public static void main(String[] args) {
        try {
            long startTime = System.currentTimeMillis();
            String indexName = "cn_gov_purchase_index";
            String typeName = "cn_gov_purchase_index";
            createIndex(indexName);
            writeMysqlDataToES(indexName,typeName);
...
/**
    ...
    public static void createIndex(String indexName) throws IOException {
       ...
       */
/* HttpHost httpHost = new HttpHost("20.0.0.100", 9200);
...
/**
    ...
    private static void writeMysqlDataToES(String tableName,String typeName) {

        RestHighLevelClient client = new RestHighLevelClient(RestClient.builder(new HttpHost("20.0.0.100", 9200, "http")));// 初始化
        ...
        try {
         ...
         //   String sql = "SELECT * from " + tableName;
            String sql =   "SELECT * FROM  spider_71_ggzy_zgzfcgw_content";
            ...
            while (rs.next()) {
                ...
                if (count % 100000 == 0) {
                    ...
                    for (HashMap<String, String> hashMap2 : dataList) {
                        bulkProcessor.add(new IndexRequest(tableName.toLowerCase(), typeName, hashMap2.get("S_GUID"))
                                .source(hashMap2));
                    }
                    // 每提交一次便将map与list清空
                    map.clear();
            ...
            for (HashMap<String, String> hashMap2 : dataList) {
                bulkProcessor.add(
                        new IndexRequest(tableName.toLowerCase(), typeName, hashMap2.get("S_GUID")).source(hashMap2));
            }
