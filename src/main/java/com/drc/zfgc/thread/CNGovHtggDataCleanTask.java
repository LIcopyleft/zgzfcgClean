...
public class CNGovHtggDataCleanTask implements Runnable {

    private int beginIndex;
    private int endIndex;
    private ConfigParam config;
    static DataContentMapper mapper = SpringContextHolder.getBean("dataContentMapper");
    private static final Logger logger = LoggerFactory.getLogger(CNGovHtggDataCleanTask.class);


    public CNGovHtggDataCleanTask(int beginIndex, ConfigParam config) {
        this.beginIndex = beginIndex;
        this.config = config;
    }

    public CNGovHtggDataCleanTask(int beginIndex, int endIndex, ConfigParam config) {
        this.beginIndex = beginIndex;
    ...
    //    DataBusinessDel.categoryDel(cleanData);
        ...
        ConventUtils.cleanDataLengthDel(cleanData);
        if (!"中标公告".equals(cleanData.getType()) && !"成交公告".equals(cleanData.getType())&& !"合同公告".equals(cleanData.getType())) {
