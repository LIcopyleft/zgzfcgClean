...
public class CleanMethod {
    ...
    private static Logger logger = LoggerFactory.getLogger(CleanMethod.class);


    public static CNGovCleanData clean(Map<String, String> dataMap) throws InvocationTargetException, IllegalAccessException {
        CNGovDataUrl data = new CNGovDataUrl();
        ConventUtils.map2CNGovDataUrl(dataMap, data);
        return clean(data);
    ...
    public static CNGovCleanData clean(CNGovDataUrl data) throws InvocationTargetException, IllegalAccessException {
       /* if (data.getUrlId() == 8210476) {
        ...
        logger.info("clean..." + data.getUrlId());
